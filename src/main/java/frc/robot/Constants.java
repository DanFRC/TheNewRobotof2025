...
public final class Constants {
  ...
  public static class ElevatorConstants {
    ...
    public static final double kElevatorDeadZoneMax = 16350;
    public static final double kElevatorDeadZoneMin = 10;

    public static final double kElevatorMid = 8000;
    public static final double kElevatorLow = 2000;
    public static final double kElevatorDropper = 4000;

    public static final double kElevatorNeutral = 7560;
  ...
  public static class ArmPivotConstants {
    ...
    public static final double kArmPivotNeutral = 0.62;
    public static final double kArmPivotHighScore = 0.365;
